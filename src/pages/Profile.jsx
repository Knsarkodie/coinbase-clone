...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const { data } = await axios.get('https://knsarkodie-coinbase-backend-api.onrender.com/api/auth/profile', {
  ...
  const handleAddCrypto = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://knsarkodie-coinbase-backend-api.onrender.com/api/crypto', {
        name: formData.name,
  ...
  const handleLogout = async () => {
    try {
      await axios.post('https://knsarkodie-coinbase-backend-api.onrender.com/api/auth/logout', {}, {
        withCredentials: true
      });
      navigate('/signin');
    } catch (error) {
